...
export const collections = [
    ...
    { folder: 'vacas', name: 'Vacas', description: 'La serie Vacas es un homenaje al animal mítico por excelencia en la cultura mediterránea y esencial en la configuración milenaria de la cultura montañesa asturiana. Aquí Lucas crea un elocuente e impactante diálogo entre el hombre y el animal por medio de su humanización, proyectando de este modo lo mágico-surreal, lo sorpresivo, lo incongruente, la ironía o la crítica social y política en sus creaciones. La obra se convierte así en una parte esencial de vida.'},
